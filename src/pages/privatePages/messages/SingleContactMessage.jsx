    ...
    <div className="flex">
      ...
      <div className="bg-white/80 w-full p-4 lg:p-10  rounded-lg">
        ...
        <div className="w-full flex items-center justify-between my-10">
          ...
          <div className="letf">
            <div className="!mb-0 "> <span className="font-semibold mr-4" >Sender:</span>  {singlemessage?.fullName}</div>
            <span className="text-sm"> <span className="font-semibold mr-4" >Sender Email:</span>  {singlemessage?.email}</span>
          </div>
